"""
Refer pre-process code from https://github.com/GestaltCogTeam/BasicTS/tree/master.
"""
import os
import sys
import shutil
...
from generate_adj_mx import generate_adj_tpims
...
def generate_data(args: argparse.Namespace):
    ...
    Default settings of TPIMS dataset:
    ...
    data = np.genfromtxt('datasets/raw_data/TPIMS/TPIMS.csv', delimiter=',', skip_header=1, usecols=range(1, 105))
    ...
    test_num_short = int(num_samples * (1 - train_ratio))
    valid_num_short = 0
...
if __name__ == "__main__":
    ...
    GRAPH_FILE_PATH = "datasets/raw_data/{0}/adj_mx_{0}.pkl".format(DATASET_NAME)
